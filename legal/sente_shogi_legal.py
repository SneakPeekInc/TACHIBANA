...
class SenteShogi():
    def __init__(self):
        ...
        self.GYOKU_LEGAL_SENTE = [(r, c) for r in [-1,0,1] for c in [-1,0,1]]
        self.GYOKU_LEGAL_SENTE.remove((0,0))
        self.OUTE_dic = {
    ...
    def keima(self,ls):
        ...
        if ls[0] == (-1,9):
            ...
            tp = self.get_coordinate_info(ls)
            if tp in self.KEIMA_LEGAL_SENTE:
                return True
            else: return False
    ...
    def kin(self,info):
        ...
        if info[0] == (-1,9):
            ...
            tp = self.get_coordinate_info(info)
            if tp in self.KIN_LEGAL_SENTE:
                return True
            else: return False
    ...
    def gyoku(self,ls):
        ...
        if ls[0] == (-1,9):
            ...
            tp = self.get_coordinate_info(ls)
            if tp in self.GYOKU_LEGAL_SENTE:
                return True
            else: return False
    ...
    def _around_ote(self,r,c,board):
        ...
        for v in self.GYOKU_LEGAL_SENTE:
            r1 = r-v[0]
            c1 = c-v[1]
            #print("見ているマス目：",r1,c1)
    ...
    def _hisya_kaku_ote(self,r,c,board):
        ...
        for direction in self.GYOKU_LEGAL_SENTE:
            y = r + direction[0]
            x = c + direction[1]
            while True:
    ...
    def judge(self, board, info):
        ...
        if (r_b,c_b) == (-1, 9):
            ...
            if (board[r_b][c_b] == koma-8) and (r_a < 3 or r_b < 3):
...
if __name__ == "__main__":
    ...
    print(legal.is_ote(board))


    """
    print("True",legal.judge(board, info, komadai))
    info = [(8,0),(2,0),10]
    print("True",legal.judge(board, info, komadai))
    info = [(1,7),(5,7),14]
    print("True-test",legal.judge(board,info,komadai))
    info = [(4,4),(2,3),11]
    print("True",legal.judge(board, info, komadai))
    info = [(2,4),(3,4),11]
    print("True",legal.judge(board, info, komadai))
